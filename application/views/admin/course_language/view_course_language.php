                            ...
                            <tbody>
                                ...
                                foreach ($course_language_view as $row) : ?>
                                    <tr>
                                        ...
                                        <td class="text-right"><a href="<?= base_url('admin/course_language/course_language_edit/' . $row->id); ?>">
                          <i class="fas fa-edit" style="font-size: 24px; color: blue;"></i></a>
                        <a href="<?= base_url('admin/course_language/course_language_delete/' . $row->id); ?>" onclick="return confirm('Are you sure want to delete ?');">

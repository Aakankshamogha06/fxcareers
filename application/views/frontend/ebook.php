        ...
        <div class="row gy-4 align-items-center">
            ...
            <div class="col-xl-6">
                <div class="card overflow-hidden ebook-card wow slideInLeft">
                    <div class="row no-gutters">
                        <div class="col-md-4">
                            <img src="<?=base_url()?>public/web/img/ebooks/what-is-investment.jpg" class="card-img rounded-0 h-100 object-fit-cover" alt="What is Investment" />
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <a href="<?=base_url()?>public/web/docs/what-is-investment.pdf" class="btn btn-primary" target="_blank">View Book</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-6">
                <div class="card overflow-hidden ebook-card wow slideInRight">
                    <div class="row no-gutters">
                        <div class="col-md-4">
                            <img src="<?=base_url()?>public/web/img/ebooks/swing-trading.jpg" class="card-img rounded-0 h-100 object-fit-cover" alt="Swing Trading" />
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <a href="<?=base_url()?>public/web/docs/swing-trading.pdf" class="btn btn-primary" target="_blank">View Book</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-6">
                <div class="card overflow-hidden ebook-card wow slideInLeft">
                    <div class="row no-gutters">
                        <div class="col-md-4">
                            <img src="<?=base_url()?>public/web/img/ebooks/what-is-trading.jpg" class="card-img rounded-0 h-100 object-fit-cover" alt="What is Trading" />
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <a href="<?=base_url()?>public/web/docs/what-is-trading.pdf" class="btn btn-primary" target="_blank">View Book</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-6">
                <div class="card overflow-hidden ebook-card wow slideInRight">
                    <div class="row no-gutters">
                        <div class="col-md-4">
                            <img src="<?=base_url()?>public/web/img/ebooks/indicator-rsi.jpg" class="card-img rounded-0 h-100 object-fit-cover" alt="Indicator-RSI" />
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <a href="<?=base_url()?>public/web/docs/indicator-RSI.pdf" class="btn btn-primary" target="_blank">View Book</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-6">
                <div class="card overflow-hidden ebook-card wow slideInLeft">
                    <div class="row no-gutters">
                        <div class="col-md-4">
                            <img src="<?=base_url()?>public/web/img/ebooks/forex-terminology.jpg" class="card-img rounded-0 h-100 object-fit-cover" alt="Forex Terminology" />
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <a href="<?=base_url()?>public/web/docs/forex-terminology.pdf" class="btn btn-primary" target="_blank">View Book</a>
                            </div>
                        </div>
                    </div>
                </div>

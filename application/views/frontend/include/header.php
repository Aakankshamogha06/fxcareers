                  ...
                  <div class="col-xl-8 col-lg-8 col-md-5 col-sm-4">
                     <div class="it-header-2-top-left">
                        <ul class="text-center text-sm-start">
                           ...
                           <li>
                              <a href="mailto:info@fxcareers.com">
                                 <span>
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <nav class="it-menu-content">
                                 <ul>
                                    ...
                                    <li class="has-dropdown">
                                       ...
                                       <ul class="it-submenu submenu">
                                          <li><a href="one-to-one-session">One To One Sessions</a></li>
                                          <li><a href="become-partner">Become Partner</a></li>

                                       </ul>
                                    </li>
                                    <li><a href="trade-idea">Trade Idea</a></li>

   ...
   <main>
               ...
               <div class="row gx-0">
                  <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                     <div class="it-funfact-item d-flex align-items-center">
                        ...
                        data-purecounter-end="3">0</i>k+</h6>
                  ...
                  <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                     <div class="it-funfact-item d-flex align-items-center">
                        ...
                        <div class="it-funfact-content">
                           <h6><i class="purecounter" data-purecounter-duration="1"
                        data-purecounter-end="15">0</i>k+</h6>
                  ...
                  <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                     <div class="it-funfact-item d-flex align-items-center">
                        ...
                        <div class="it-funfact-content">
                           <h6><i class="purecounter" data-purecounter-duration="1"
                        data-purecounter-end="97"></i>k+</h6>
                  ...
                  <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                     <div class="it-funfact-item d-flex align-items-center">
                        ...
                        <div class="it-funfact-content">
                           <h6><i class="purecounter" data-purecounter-duration="1"
                        data-purecounter-end="102"></i>k+</h6>
               ...
               <div class="row align-items-end">
                  <div class="col-xl-6 col-lg-8 col-md-9 col-sm-8">
                     <div class="it-testimonial-title-box">
                        <span class="it-section-subtitle ps-0">
                           <img src="<?=base_url()?>public/web/assets/img/category/inner.svg" alt="">
                           testimonial
                        </span>
      ...
      <!-- course-area-start -->
      <div class="it-course-area it-sub-bg-none p-relative grey-bg pt-120 pb-120">
         ...
         <div class="container">
            ...
            <div class="row">
               <div class="col-xl-3 col-lg-4 col-md-6 mb-30">
                  <div class="it-team-3-item text-center">
                     <div class="it-team-3-thumb fix">
                        <img src="<?=base_url()?>public/web/assets/img/team/team-3-1.jpg" alt="">
                     </div>
               ...
               <div class="col-xl-3 col-lg-4 col-md-6 mb-30">
                  <div class="it-team-3-item text-center">
                     <div class="it-team-3-thumb fix">
                        <img src="<?=base_url()?>public/web/assets/img/team/team-3-2.jpg" alt="">
                     </div>
                     <div class="it-team-3-content">
                        <!-- <div class="it-team-3-social-box p-relative">
                           <button>
               ...
               <div class="col-xl-3 col-lg-4 col-md-6 mb-30">
                  <div class="it-team-3-item text-center">
                     <div class="it-team-3-thumb fix">
                        <img src="<?=base_url()?>public/web/assets/img/team/team-3-3.jpg" alt="">
                     </div>
                     <div class="it-team-3-content">
                        <!-- <div class="it-team-3-social-box p-relative">
                           <button>
               ...
               <div class="col-xl-3 col-lg-4 col-md-6 mb-30">
                  <div class="it-team-3-item text-center">
                     <div class="it-team-3-thumb fix">
                        <img src="<?=base_url()?>public/web/assets/img/team/team-3-4.jpg" alt="">
                     </div>
                     <div class="it-team-3-content">
                        <!-- <div class="it-team-3-social-box p-relative">
                           <button>

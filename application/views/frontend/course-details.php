         ...
         <div class="row">
            <div class="col-xl-9 col-lg-8">
               <div class="it-course-details-wrap">
                  ...
                  <h4 class="it-evn-details-title mb-0 pb-5">Web Development Fully Complete
                     Guideline</h4>
               ...
               <div class="it-evn-sidebar-box it-course-sidebar-box">
                  ...
                  <div class="it-course-sidebar-rate-box pb-20">
                     <div class="it-course-sidebar-rate d-flex justify-content-between align-items-center">
                        ...
                        <span class="rate">$60 <i>$120</i></span>
                     </div>
                     <i>29-da money-back guarantee</i>
                  </div>
                  <a class="it-btn w-100 text-center mb-20" href="book-slot.php">
                     <span>
                        Book Now
                  ...
                  <div class="it-evn-sidebar-list">
                     <ul>
                        <li><span> <i class="fa-regular fa-clock"></i> Duration</span> <span>start date</span></li>
                        <li><span> <i class="fa-solid fa-toggle-off"></i> Mode</span><span>100</span></li>
                        <li><span> <i class="fa-solid fa-globe"></i> Language</span><span>80</span></li>
                        <li><span> <i class="fa-solid fa-medal"></i> Certificate</span><span>Basic</span></li> 
                     </ul>
                  </div>
               </div>
            </div>

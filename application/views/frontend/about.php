        ...
        <div class="row align-items-center">
            <div class="col-lg-5 mb-5 mb-lg-0">
                <div class="wow fadeInLeft" data-wow-duration="1000ms">
                    <img class="img-fluid" src="<?=base_url()?>public/web/img/about.png">
                </div>
            </div>
            <div class="col-lg-7">
        ...
        <div class="row mt-5 g-4 justify-content-center">
            <div class=" col-lg-6 col-md-6">
                <div class="mission-card card text-center border-primary wow slideInLeft">
                    <img src="<?=base_url()?>public/web/img/mission.png" class="img-fluid mx-auto mt-3" alt="OUR MISSION" width="100" />
                    <div class="card-body">
            ...
            <div class="col-lg-6 col-md-6">
                <div class="mission-card card text-center border-primary wow slideInRight">
                    <img src="<?=base_url()?>public/web/img/vission.png" class="img-fluid mx-auto mt-3" alt="OUR VISION" width="100" />
                    <div class="card-body">
                ...
                <div class="row gy-4">
                    <div class="col-md-4">
                        <div class="how-we-card card overflow-hidden text-center bg-transparent text-white h-100 border-primary wow slideInRight" data-wow-delay="200ms">
                            <img src="<?=base_url()?>public/web/img/Learn.png" class="img-fluid custom-card-img mx-auto mt-3" alt="Learn" />
                            <div class="card-body">
                    ...
                    <div class="col-md-4">
                        <div class=" how-we-card  card overflow-hidden text-center bg-transparent text-white h-100 border-primary wow slideInRight" data-wow-delay="400ms">
                            <img src="<?=base_url()?>public/web/img/Grow.png" class="img-fluid custom-card-img mx-auto mt-3" alt="Grow" />
                            <div class="card-body">
                    ...
                    <div class="col-md-4">
                        <div class=" how-we-card card overflow-hidden text-center bg-transparent text-white h-100 border-primary wow slideInRight" data-wow-delay="600ms">
                            <img src="<?=base_url()?>public/web/img/Sucess.png" class="img-fluid custom-card-img mx-auto mt-3" alt="Succeed" />
                            <div class="card-body">
    ...
    <div class="container-fluid">
        <div class="row align-items-center  mb-md-0">
            <div class="col-md-6 wow fadeInLeft h-100 p-0">
                <img src="<?=base_url()?>public/web/img/learning.jpg" alt="Learning at FXCareers" class="img-fluid" />
            </div>

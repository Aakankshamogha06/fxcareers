...
<!-- Header Start -->
<section class="">
<div class="breadcrumb-sec  online-bg main-section position-relative overlay-bottom">
    <div class="container position-relative text-center text-lg-left">
        <div class="breadscrumb-title">
            <h1 class="text-white display-3 mb-4 wow fadeInUp">Online Program</h1>
            <div class="d-inline-flex text-white mb-4 wow fadeInUp" data-wow-delay="100ms">
                ...
                <p class="m-0 text-uppercase">Online Program</p>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row mx-0 justify-content-center">
            <div class="col-lg-8">
                <div class="section-title text-center position-relative mb-5">
                    ...
                    <h2 class="display-6 wow fadeInUp">Online Training Programs</h2>
                </div>
            </div>
        </div>

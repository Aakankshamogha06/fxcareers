	...
	public function sub_gallery_submit_data()
	{
		if ($this->session->has_userdata('is_admin_login')) {
			...
			if ($this->input->post()) {
				...
				if ($this->sub_gallery_model->sub_gallery_data_submit($data,$image) == true) {
			...
			if ($this->input->post()) {
				...
				if ($this->sub_gallery_model->sub_gallery_update_data($data,$image) == true) {
				...
				public function sub_gallery_delete($id)
				{
					if ($this->session->has_userdata('is_admin_login')) {
						...
						if ($this->sub_gallery_model->sub_gallery_delete($id) == true) {

							redirect("sub_gallery/view_sub_gallery");
			}
			} else {
				redirect('admin/auth/login');
		}
